    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <section>
          ...
          <p>
            باستخدامك لمنصة منهل (Manhal Academy)، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء منها، يرجى عدم استخدام المنصة.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            جميع المحتويات، الفيديوهات، والمناهج المقدمة على المنصة هي ملكية فكرية لمنصة منهل. يُمنع منعاً باتاً نسخها أو تسجيلها أو إعادة نشرها بأي شكل من الأشكال.
          </p>
        </section>
