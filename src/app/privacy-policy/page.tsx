    ...
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      ...
      <div className="space-y-6 text-muted-foreground leading-relaxed">
        <section>
          ...
          <p>
            في منصة منهل (Manhal Academy)، نولي أهمية قصوى لخصوصية مستخدمينا (الطلاب، أولياء الأمور، والمعلمين). تشرح هذه السياسة كيفية جمعنا للمعلومات، استخدامها، وحمايتها.
          </p>
        </section>
