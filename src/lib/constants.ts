...
export const APP = {
  ...
  supportEmail: "support@dars-academy.com",
...
export const TESTIMONIALS = [
  {
    ...
    text: "ابني محمد (10 سنوات) كان يكره الرياضيات، وبعد 3 شهور مع منصة درس بقى بيحب الحساب وبيقولي مسائل بنفسه! ربنا يبارك فيكم.",
    rating: 5,
    avatar: "👩",
  },
  {
...
export const FAQS = [
  {
    q: "ما الصفوف والمواد المتاحة على المنصة؟",
    a: "المنصة مصممة لاستضافة معلمين لجميع المراحل من التأسيس والابتدائي حتى الثانوي، ولمختلف المواد والمناهج العربية والدولية. تظهر الخيارات المتاحة حسب بلد الطالب والصف والمادة.",
  },
  {
    q: "كيف أختار المعلم المناسب؟",
    a: "حدّد الصف والمادة والمنهج، ثم قارن بين ملفات المعلمين وخبراتهم وتقييماتهم وأسعارهم ومواعيدهم. ويمكنك طلب حصة تجريبية قبل الالتزام بخطة أطول.",
  },
  {
    q: "هل تعمل المنصة في جميع الدول العربية؟",
    a: "نعم، المنصة أونلاين ومهيأة لخدمة الطلاب والمعلمين في الوطن العربي، مع عرض العملة وخيارات الدفع والمواعيد وفق بلد المستخدم والإعدادات المتاحة.",
  },
  {
    q: "كيف تحمي المنصة حق الطالب والمعلم؟",
    a: "تسجل المنصة الحجز والحضور والمدفوعات وسياسات الإلغاء، وتتيح التقييم والتقارير والدعم الإداري. وتُعتمد الشروط النهائية من الإدارة قبل الإطلاق التجاري.",
  },
  {
    q: "هل يمكن لولي الأمر متابعة مستوى أبنائه؟",
    a: "نعم، تعرض لوحة ولي الأمر المواعيد والحضور والواجبات والتقييمات وتقارير التقدم والمدفوعات لكل طالب، بما في ذلك دعم أكثر من ابن من الحساب نفسه.",
  },
  {
    q: "كيف أنضم إلى المنصة كمعلم؟",
    a: "أنشئ حساب معلم وأضف تخصصاتك وخبرتك وبياناتك المهنية. يراجع فريق الإدارة الطلب قبل التفعيل، وبعد القبول يمكنك ضبط أسعارك ومواعيدك واستقبال الحجوزات.",
  },
] as const;
